...
namespace MogMod.Items.Global
{
    public interface IHoldShiftTooltipItem
    {
        ...
        /// <summary>
        /// Internal ID for the TooltipLine which contains MogMod items' extended tooltips when holding SHIFT.
        /// </summary>
        internal const string ExtensionTooltipID = "MogMod:HoldShiftTooltip";

        /// <summary>
        /// Internal ID for the TooltipLine which contains MogMod items' "Hold SHIFT" extension indicators.
        /// </summary>
        internal const string ExtensionIndicatorTooltipID = "MogMod:HoldShiftExtensionIndicator";

        /// <summary>
        /// Internal ID for the TooltipLine which contains MogMod items' flavor tooltips.<br />
        /// Flavor tooltips on items which do not use this interface will be present in standard vanilla tooltip lines.
        /// </summary>
        internal const string FlavorTooltipID = "MogMod:FlavorTooltip";
