...
{
    public class AzursGlintstoneStaff : ModItem, ILocalizedModType
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (ammoItem.type == ModContent.ItemType<GlintstonePebble>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(GlintstonePebble.attackSpeed * .8f); // 20% faster
            ...
            else if (ammoItem.type == ModContent.ItemType<RockSling>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(RockSling.attackSpeed * .8f);
            ...
            else if (ammoItem.type == ModContent.ItemType<ShardSpiral>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(ShardSpiral.attackSpeed * .8f);
                Item.UseSound = SoundID.Item9;
            }
            else if (ammoItem.type == ModContent.ItemType<GlintstoneStars>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(GlintstoneStars.attackSpeed * .8f);
            ...
            else if (ammoItem.type == ModContent.ItemType<StarShower>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(StarShower.attackSpeed * .8f);
                Item.UseSound = SoundID.Item8;
            }
            else if (ammoItem.type == ModContent.ItemType<StarsOfRuin>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(StarsOfRuin.attackSpeed * .8f);
                Item.UseSound = SoundID.Item8;
            }
            else if (ammoItem.type == ModContent.ItemType<GlintstoneArc>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(GlintstoneArc.attackSpeed * .8f);
                Item.UseSound = SoundID.Item8;
            }
            else if (ammoItem.type == ModContent.ItemType<CannonOfHaima>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(CannonOfHaima.attackSpeed * .8f);
            ...
            else if (ammoItem.type == ModContent.ItemType<FoundingRainOfStars>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(FoundingRainOfStars.attackSpeed * .8f);
                Item.UseSound = SoundID.Item8;
            }
            else if (ammoItem.type == ModContent.ItemType<ExplosiveGhostflame>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(ExplosiveGhostflame.attackSpeed * .8f);
            ...
            else if (ammoItem.type == ModContent.ItemType<CarianSlicer>())
            {
                ...
                Item.useTime = Item.useAnimation = Convert.ToInt32(CarianSlicer.attackSpeed * .8f);
                Item.UseSound = null;
            }
            return true;
        }
