...
{
    public class MeteoriteStaff : ModItem, ILocalizedModType
    {
        ...
        public override void ModifyWeaponKnockback(Player player, ref StatModifier knockback) => knockback += .5f; // doesnt work
