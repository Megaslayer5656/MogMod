...
namespace MogMod.Items.Weapons.Ranged
{
    ...
    public class DrowRangersCrossbow : ModItem, ILocalizedModType
    {
        ...
        public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs(maxShots, reloadTime.FramesToSeconds(), ArmorPenetration);
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<DrowRangersCrossbowHoldout>();
            Item.shootSpeed = 3f;
