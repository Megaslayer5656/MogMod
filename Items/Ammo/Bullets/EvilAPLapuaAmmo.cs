...
namespace MogMod.Items.Ammo.Bullets
{
    public class EvilAPLapuaAmmo : ModItem, ILocalizedModType
    {
        ...
        public override string Texture => "MogMod/Items/Ammo/Bullets/EnergyBullet";
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frameI, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            if (!Main.zenithWorld)
                return true;
            Texture2D texture = ModContent.Request<Texture2D>("MogMod/Items/Ammo/Bullets/EnergyBullet").Value;
