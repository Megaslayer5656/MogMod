    ...
    public class TheGravityManaBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (Main.rand.NextBool(3))
            {
                ...
                int dust = Dust.NewDust(dustCorner, player.width + 4, player.height + 4, Main.rand.NextBool(3) ? 41 : 45, player.velocity.X * 0.4f, player.velocity.Y * 0.4f, 100, default, 1.4f);
