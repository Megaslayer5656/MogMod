...
{
    public class AghanimHexDebuff : ModBuff
    {
        ...
        {
            player.MogMod().aghHexDebuff = true;
        }
        ...
        internal static void DrawEffects(PlayerDrawSet drawInfo)
        {
            ...
            int dust = Dust.NewDust(drawInfo.Position - new Vector2(2f), player.width + 4, player.height + 4, Main.rand.NextBool(3) ? 173 : 295, player.velocity.X * 0.4f, player.velocity.Y * 0.4f, 100, default, 1.4f);
