...
{
    public class RuntyDrillProj : ModProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Projectiles.Tools";
        ...
        public override void SetDefaults() {
			...
			Projectile.aiStyle = ProjAIStyleID.Drill; // Replace with -1 if you want custom code
		}
        /*
		...
		public override void AI() {
			...
			if (Main.rand.NextBool(10)) {
				Dust dust = Dust.NewDustDirect(Projectile.position + Projectile.velocity * Main.rand.Next(6, 10) * 0.15f, Projectile.width, Projectile.height, , 0f, 0f, 80, Color.White, 1f);
				dust.position.X -= 4f;
				dust.noGravity = true;
