...
{
    public class GingyPet : ModProjectile, ILocalizedModType
    {
		...
		public override void SetDefaults() {
			Projectile.CloneDefaults(ProjectileID.BabyFaceMonster); // Copy the stats of the Zephyr Fish

			AIType = ProjectileID.BabyFaceMonster; // Mimic as the Zephyr Fish during AI.
            Projectile.width = Projectile.height = 50;
            Projectile.scale = Main.zenithWorld ? 5f : 0.5f;
		}
		...
		public override void AI() {
			...
			if (!player.dead && player.HasBuff(ModContent.BuffType<GingyBuff>())) {
