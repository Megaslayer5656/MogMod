    ...
    public class FrozenSpearProjectile : ModProjectile //This whole file is straight from examplemod. Thank you examplemod.
    {
        ...
        public override bool PreAI()
        {
            ...
            if (!Main.dedServ)
            {
                ...
                {
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Ice, Projectile.velocity.X * 2f, Projectile.velocity.Y * 2f, Alpha: 128, Scale: 1.2f);
                }

                if (Main.rand.NextBool(4))
                {
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Ice, Alpha: 128, Scale: 0.3f);
                }
            }
