...
{
    public class EvilAssChaosStarProj : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 420)
                MogModUtils.HomeInOnNPC(Projectile, true, 700f, 12f, 15f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Projectile.DrawStarTrail(Color.DarkRed, Color.White);
