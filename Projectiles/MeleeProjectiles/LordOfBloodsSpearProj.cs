...
{
    public class LordOfBloodsSpearProj : ModProjectile, ILocalizedModType
    {
        ...
        protected virtual float HoldoutRangeMax => 182f;
        ...
        public override bool PreAI()
        {
            ...
            if (!Main.dedServ)
            {
                ...
                {
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Blood, Projectile.velocity.X * 2f, Projectile.velocity.Y * 2f, Scale: 1.2f);
                }

                if (Main.rand.NextBool(4))
                {
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Blood, Scale: 0.3f);
                }
            }
