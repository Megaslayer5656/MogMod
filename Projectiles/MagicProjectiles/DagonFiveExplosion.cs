...
{
    public class DagonFiveExplosion : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            if (Projectile.timeLeft >= 8)
            {
                for (int i = 0; i < 10; i++)
                {
                    ...
                    int dagonDust = Dust.NewDust(Projectile.Center, Projectile.width, Projectile.height, 174, 0, 0, 100, default, 2.5f);
