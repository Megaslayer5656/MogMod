...
namespace MogMod.Projectiles.MagicProjectiles
{
    public class AghanimLaser : BaseLaserbeamProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            DrawBeamWithColor(new Color(128, 0, 255, 50), Projectile.scale);
            DrawBeamWithColor(Color.Lerp(new Color(255, 0, 255, 50), Color.Transparent, 0.35f), Projectile.scale * 0.6f);
            DrawBeamWithColor(Color.Lerp(new Color(128, 0, 255, 50), Color.Transparent, 0.35f), Projectile.scale * 0.6f);
            return false;
        }
