...
{
    public class OrchidBeam : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                for (int d = 0; d < 2; d++)
                {
                    ...
                    int i = Dust.NewDust(Projectile.Center, 0, 0, DustID.HallowedTorch, 0f, 0f, 160, default, 1f);
            ...
            if (Projectile.localAI[0] > 0f)
            {
                for (int d = 0; d < 2; d++)
                {
                    ...
                    int i = Dust.NewDust(source, 1, 1, 66, 0f, 0f, 0, Color.LightPink, 1f);
                    Main.dust[i].noGravity = true;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            int healAmount = (int)(player.statLifeMax2 * 0.008f);
