...
{
    public class StrongDagonExplosion : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft >= 8)
            {
                ...
                int dustNum = (int)MathHelper.Clamp(Timer * 6f, 2f, 6f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D bloomRingTex = ModContent.Request<Texture2D>("MogMod/Assets/Textures/GlowRingParticle").Value;
            ...
            for (int i = 0; i < 8; i++)
            {
                if (i % 2 == 0)
                {
                    Main.EntitySpriteDraw(ringTex, drawPosition, null, drawColour * 0.85f, rotation, ringTex.Size() * 0.5f, Projectile.scale * Timer * 0.1f, SpriteEffects.None);
                    Main.EntitySpriteDraw(ringTex, drawPosition, null, drawColour * 0.85f, rotation + MathHelper.PiOver2, ringTex.Size() * 0.5f, Projectile.scale * Timer * 0.1f, SpriteEffects.None);
                    Main.EntitySpriteDraw(ringTex, drawPosition, null, drawColour * 0.85f, rotation + MathHelper.Pi, ringTex.Size() * 0.5f, Projectile.scale * Timer * 0.1f, SpriteEffects.None);
                    Main.EntitySpriteDraw(ringTex, drawPosition, null, drawColour * 0.85f, rotation + MathHelper.Pi + MathHelper.PiOver2, ringTex.Size() * 0.5f, Projectile.scale * Timer * 0.1f, SpriteEffects.None);
                }
                Main.EntitySpriteDraw(bloomRingTex, drawPosition, null, drawColour * 0.85f, Projectile.rotation, bloomRingTex.Size() * 0.5f, Projectile.scale * ((Timer * 0.05f) * i), SpriteEffects.None);
                Main.EntitySpriteDraw(bloomRingTex, drawPosition, null, drawColour * 0.35f, Projectile.rotation, bloomRingTex.Size() * 0.5f, Projectile.scale * ((Timer * 0.1f) * i), SpriteEffects.None);
                Main.EntitySpriteDraw(bloomTex, drawPosition, null, drawColour * 0.75f, Projectile.rotation, bloomTex.Size() * 0.5f, Projectile.scale * ((Timer * 0.05f) * i), SpriteEffects.None);
                Main.EntitySpriteDraw(bloomTex, drawPosition, null, drawColour * 0.5f, Projectile.rotation, bloomTex.Size() * 0.5f, Projectile.scale * ((Timer * 0.075f) * i), SpriteEffects.None);
                Main.EntitySpriteDraw(bloomTex, drawPosition, null, drawColour * 0.35f, Projectile.rotation, bloomTex.Size() * 0.5f, Projectile.scale * ((Timer * 0.1f) * i), SpriteEffects.None);
            }
