...
{
    public class CarianSlicerHoldout : BaseSwordHoldoutProjectile, ILocalizedModType
    {
        ...
        public override SoundStyle? UseSound => SoundID.Item9 with { Volume = 0.9f, Pitch = Main.rand.NextFloat(0.1f, 0f) };
        ...
        public override void Spawn()
        {
            ...
            RotateInStartup = 1;
            HitsLeft = CarianSlicer.MaxReflects;
        }
        ...
        private void Reflect(Projectile sword)
        {
            ...
            foreach (Projectile proj in Main.projectile.Where(proj => proj.active && proj.hostile && proj.damage > 0 && proj.type != null && proj.damage <= damageCap && sword.Colliding(swordBox, proj.Hitbox)))
            {
                ...
                aimVel = (proj.Center - Owner.MogMod().mouseWorld).SafeNormalize(Vector2.UnitX) * 50f;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (Projectile.numHits <= 2)
            {
                ...
                if (Projectile.numHits == 0)
                {
                    ...
                    SoundEngine.PlaySound(SoundID.DD2_MonkStaffGroundMiss with { Volume = 0.55f, Pitch = 0.7f }, Projectile.Center);
        ...
        {
            Texture2D ghost = ModContent.Request<Texture2D>("MogMod/Assets/Ghosts/CarianSlicerGhost").Value;
