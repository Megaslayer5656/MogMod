...
namespace MogMod.Projectiles.MagicProjectiles.Sorceries
{
    public class GlintstoneStarsHomingProj : ModProjectile, ILocalizedModType
    {
        ...
        public static Color Colour => new(122, 202, 255);
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 590)
                MogModUtils.HomeInOnNPC(Projectile, false, 550f, 8f, 12f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                int dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.AncientLight, 0f, 0f, 100, Color.LightBlue, 1f);
                Main.dust[dust].noGravity = true;
                Main.dust[dust].velocity *= 1.2f;
                Main.dust[dust].velocity -= Projectile.oldVelocity * 0.3f;

                int dust2 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.ManaRegeneration, Projectile.oldVelocity.X, Projectile.oldVelocity.Y, 100, default, 1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < Projectile.oldPos.Length; i++)
            {
                ...
                float trailScale = MathHelper.Lerp(0.3f, 1f, 1f - completionRatio);
