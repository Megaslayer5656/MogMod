...
{
    public class AdulasMoonbladeHoldout : BaseSwordHoldoutProjectile, ILocalizedModType
    {
        ...
        public override void Spawn()
        {
            ...
            RotateInStartup = 1;
            HitsLeft = AdulasMoonblade.MaxReflects;
        }
        ...
        {
            Texture2D ghost = ModContent.Request<Texture2D>("MogMod/Assets/Ghosts/AdulasMoonbladeGhost").Value;
