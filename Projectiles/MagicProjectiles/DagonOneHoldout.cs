...
{
    public class DagonOneHoldout : BaseHoldoutProjectile
    {
        public override LocalizedText DisplayName => MiscUtils.GetItemName<DagonOne>();
        public override string Texture => "MogMod/Items/Weapons/Magic/DagonOne";
        ...
        public static Color WeakColor => DagonOne.WeakColor;
        public static Color StrongColor => DagonOne.StrongColor;
            ...
            else
            {
                if (Timer >= MinCharge)
                {
                    ...
                    if (!coolingDown)
                    {
                        ...
                        {
                            Dust dust2 = Dust.NewDustPerfect(Projectile.Center + Projectile.velocity * 20f, Main.rand.NextBool(3) ? DustID.AncientLight : DustID.Torch, -(Projectile.velocity * Main.rand.NextFloat(-1.5f, 1.5f)).RotatedByRandom(1.4f));
                    ...
                    int type = ModContent.ProjectileType<VeryWeakDagonBolt>();
        ...
        public override void PreDrawBehind(ref Color lightColor)
        {
            ...
            Texture2D ghost = ModContent.Request<Texture2D>("MogMod/Assets/Ghosts/DagonOneGhost").Value;
