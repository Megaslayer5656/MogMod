...
{
    public class MoonveilProj : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(5))
            {
                ...
                Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, Main.rand.NextBool(3) ? DustID.GemDiamond : DustID.GemSapphire, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 100);
            }
