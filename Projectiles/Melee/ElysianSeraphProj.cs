...
{
    public class ElysianSeraphProj : BaseShortswordProjectile, ILocalizedModType
    {
        ...
        public override float TotalDuration => 20f;
        ...
        public override Action<Projectile> EffectBeforePullback => (proj) =>
        {
            ...
            Projectile.NewProjectile(source, Projectile.Center, Projectile.velocity.RotatedBy(Spread) * 3, type, Projectile.damage, Projectile.knockBack, Projectile.owner);
            Projectile.NewProjectile(source, Projectile.Center, Projectile.velocity * 3, type, Projectile.damage, Projectile.knockBack, Projectile.owner);
            Projectile.NewProjectile(source, Projectile.Center, Projectile.velocity.RotatedBy(-Spread) * 3, type, Projectile.damage, Projectile.knockBack, Projectile.owner);
        };
