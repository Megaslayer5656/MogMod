...
{
    public class FrostExplosion : ModProjectile, ILocalizedModType
    {
        ...
        public static readonly SoundStyle boom = new("Terraria/Sounds/Item_14")
        {
            Volume = 0.7f,
            PitchVariance = 0.2f,
            MaxInstances = 15
        };
        public static Color Colour => new(0, 251, 255);
        ...
        public override void AI()
        {
            ...
            if (Time < Fadetime)
            {
                ...
                Dust cinder = Dust.NewDustDirect(cinderPos, 4, 4, DustID.SnowflakeIce, Projectile.velocity.X * 0.25f, Projectile.velocity.Y * 0.25f, 10, default, 0.75f);
                ...
                int fireDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.FrostHydra, 0f, 0f, 200, Utils.SelectRandom(Main.rand, new Color[] { Color.Black, Colour }), fireSize);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) => target.AddBuff(ModContent.BuffType<FreezingDebuff>(), 300);
        public override void OnHitPlayer(Player target, Player.HurtInfo info) => target.AddBuff(ModContent.BuffType<FreezingDebuff>(), 300);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (float j = 1f; j >= 0f; j -= length)
            {
                ...
                // draw og proj
                Main.EntitySpriteDraw(fire, firePos, sourceRectangle, innerColor, 0f, origin, fireSize, SpriteEffects.None);
            }
            return false;
        }
    }
